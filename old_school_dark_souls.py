...
def character_info():
    ...
    print(f"{'Profession':<12}{'HP':<6}{'STR':<6}{'DEX':<6}{'INT':<6}")
    print("-" * 60)
    print(f"{skills['name'].title():<12}{skills['health']:<6}{skills['strength']:<6}{skills['dexterity']:<6}{skills['intelligence']:<6}")
    print("-" * 60)
    ...
    while True:
        if int(enemy['health']) > 0:
            ...
            if skills['health'] <= 0:
                ...
                return  # Exit function if player is dead
        else:
...
def rest_at_bonfire():
    ...
    print("You came across a bonfire,\nrest and have a Siegbräu")
    select_profession[player_profession]['health'] += 4
#Active game----------------------------------------------------------------------------------------
while True:
    skills = get_player_stats()
